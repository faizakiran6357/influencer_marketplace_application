...
//   /// Save FCM token in Supabase user table
...
//     _local.show(0, title, body, platformDetails);
//   }

//   /// Send push message via Firebase HTTP v1 API
...
//   /// Save FCM token to Supabase user table
//   static Future<void> _saveTokenToUser(String token) async {
//     final user = _supabase.auth.currentUser;
//     if (user != null) {
//       await _supabase
//           .from('profiles') // <-- Use 'profiles' table for both brands/influencers
//           .update({'fcm_token': token})
//           .eq('id', user.id);
//       print("✅ FCM Token saved for user: ${user.email}");
//     }
