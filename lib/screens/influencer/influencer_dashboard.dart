...
//     final hasYouTube = influencer?.youtubeChannelName != null &&
//     influencer!.youtubeChannelName!.isNotEmpty &&
//     influencer.youtubeSubscribers != null;

// final name = hasYouTube
//     ? influencer!.youtubeChannelName!
//     : (influencer?.name ?? "Influencer");

// final bio = hasYouTube && influencer!.youtubeDescription?.isNotEmpty == true
//     ? influencer!.youtubeDescription!
//     : (influencer?.bio?.isNotEmpty == true ? influencer!.bio! : "No bio available");

// final followers = hasYouTube
//     ? (influencer!.youtubeSubscribers ?? 0)
//     : (influencer?.followerCount ?? 0);

// final profileImage = hasYouTube && influencer!.youtubeChannelThumbnail?.isNotEmpty == true
...
//                                     _infoItem(
//                                       icon: Icons.people,
//                                       label: hasYouTube ? "Subscribers" : "Followers",
//                                       value: "$followers",
//                                       color: textColor,
//                                     ),
//                                     const SizedBox(width: 16),
...
//     // ✅ Determine if YouTube data is available
...
//     final isYouTubeConnected = influencer?.youtubeChannelName?.isNotEmpty == true;

//     // Name and Profile Image
//     final displayName = isYouTubeConnected
//         ? influencer!.youtubeChannelName!
//         : (influencer?.name ?? "Influencer");

//     final displayProfileImage = isYouTubeConnected && influencer!.youtubeChannelThumbnail?.isNotEmpty == true
//         ? influencer.youtubeChannelThumbnail!
//         : influencer?.profileImage;

//     // Followers / Subscribers
//     final displayFollowers = isYouTubeConnected && influencer!.youtubeSubscribers != null
//         ? influencer.youtubeSubscribers!
//         : influencer?.followerCount ?? 0;

//     // Only show manual fields if YouTube is NOT connected
//     final displayBio = !isYouTubeConnected
//         ? (influencer?.bio?.isNotEmpty == true ? influencer!.bio! : "No bio available")
//         : "";

//     final displayNiche = !isYouTubeConnected
//         ? (influencer?.niche ?? "")
//         : "";

//     final displayEngagement = !isYouTubeConnected
...
//                                         icon: Icons.category,
//                                         label: "Niche",
//                                         value: displayNiche.isNotEmpty ? displayNiche : "N/A",
//                                         color: textColor,
//                                       ),
//                                     if (!isYouTubeConnected) const SizedBox(width: 16),
//                                     _infoItem(
//                                       icon: Icons.people,
//                                       label: isYouTubeConnected ? "Subscribers" : "Followers",
