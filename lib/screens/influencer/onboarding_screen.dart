...
//       final url = await influencerProvider.uploadProfileImage(id, _profileImageBytes!);
//       if (url != null) {
...
//     final steps = [
//       _buildStep("Your Name & Bio", [_nameController, _bioController],
//           ["Full Name", "Tell us about yourself"]),
//       _buildStep("Your Niche", [_nicheController], ["e.g. Fashion, Tech, Fitness"]),
//       _buildStep("Social Accounts", [_instagramController, _tiktokController, _youtubeController],
//           ["Instagram URL", "TikTok URL", "YouTube URL"]),
//       _buildStep("Audience Details", [_followersController, _engagementController],
...
//           if (_currentStep == 0) _buildProfileImagePicker(),
//           Expanded(
//             child: PageView(
